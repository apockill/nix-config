...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "3"}, s, awful.layout.layouts[2])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "e", function () awful.util.spawn_with_shell("nautilus $DEFAULT_OPEN_DIRECTORY") end,
...
for i = 1, 9 do
	...
	-- Switch all monitors to the specified tag
	awful.key({ modkey, "Control" }, "#" .. i + 9,
                  ...
                  {description = "switch all monitors to tag #"..i, group = "tag"}),
